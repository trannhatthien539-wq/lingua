...
export function computeStats({ days = {}, streak = {}, cards = [], grammar = {}, skills = {}, goal = {} } = {}) {
  ...
  return {
    ...
    grammar: { passed: completedGrammar.length, total: 20 },
    skills: {
...
export const summarize = ({ days, streak, cards, grammar, skills, goal }) => {
  const stats = computeStats({ days, streak, cards, grammar, skills, goal });
