    ...
    <div className="fixed inset-0 z-[90] overflow-y-auto bg-[#f5f7f3] p-5 text-ink dark:bg-[#121715] dark:text-white sm:p-10">
      <div className="mx-auto flex min-h-full max-w-xl items-center justify-center">
        <section className="panel w-full p-8 text-center">
          <button onClick={onClose} className="absolute right-6 top-6 grid h-9 w-9 place-items-center rounded-lg text-ink/45 dark:text-white/45" aria-label="Đóng"><X size={18} /></button>
