...
export default function SearchPalette({ onClose, onSelect, onOpenTutor }) {
  ...
  return <Dialog onClose={onClose} ariaLabel="Tìm kiếm" initialFocusRef={inputRef} overlayClassName="fixed inset-0 z-[70] flex items-start justify-center bg-ink/30 px-4 pt-[12vh] backdrop-blur-sm dark:bg-black/60" className="w-full max-w-lg overflow-hidden rounded-2xl border border-ink/10 bg-slab shadow-soft dark:border-white/10 dark:bg-dark2">
